...
1. What is the purpose of using _sessions_?
    ...
    * Sessions allow the server to keep track of a user - and control how long they can stay logged in.

1. What does bcrypt do to help us store passwords in a secure manner?

    * `bcrypt` _hashes_ passwords `2^n` amount of times.

1. What does bcrypt do to slow down attackers?

    * _Hashing_ passwords makes it to where the passwords can't be recovered - only compared, as opposed to being encrypted - which would require a de-cryption to figure out what the password was. 

1. What are the three parts of the JSON Web Token?

    * JSON Web Tokens entail of:
        1. Header
            * Algorithm
            * Token Type
        1. Payload 
            * Claims (custom)
        1. Signature
            * Combines Header and Payload within a base64 encoded string
